...
/* @var $searchModel thienhungho\ProductManagement\modules\ProductManage\search\TermOfProductTypeSearch */
...
?>
<div class="term-of-product-type-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(t('app', 'Create'), ['create', 'type' => $type], ['class' => 'btn btn-success']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-term-of-product-type']],
        'panel' => [
