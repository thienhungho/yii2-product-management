...
/* @var $searchModel thienhungho\ProductManagement\modules\ProductManage\search\ProductSearch */
...
?>
    <div class="product-head">
        ...
        <div class="row">
            <div class="col-lg-10">
                <p>
                    <?= Html::a(t('app', 'Create') . ' ' . t('app', $product_type->name), [
                        'create',
    ...
    <div class="product-index">
        ...
        if (is_enable_multiple_language()) {
            ...
            $gridColumn[] = [
                ...
                'filterType'          => GridView::FILTER_SELECT2,
                'filter'              => \yii\helpers\ArrayHelper::map(\thienhungho\ProductManagement\modules\ProductBase\Product::find()->asArray()->all(), 'id', 'title'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions'  => [
                    'placeholder' => Yii::t('app', 'Product'),
                    'id'          => 'grid-post-search-assign-with',
                ],
            ];
            $activeButton['width'] = '222px';
            $activeButton['template'] = '{save-as-new-language} {save-as-new} {view} {update} {delete}';
            ...
            $activeButton['template'] = '{save-as-new} {view} {update} {delete}';
        }
        /**
         * Active Button
         */
